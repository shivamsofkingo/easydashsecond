const { createAccomodationUploadUrl } = require("../fileUpload/file.js");

const uploadAccomodationImages = async (param) => {
  ...
  try {
    ...
    console.log("Error in uploadAccomodationImages:", error.message);
    return false;
  }
};
...
module.exports = { uploadAccomodationImages };